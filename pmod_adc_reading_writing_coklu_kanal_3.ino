...
void writing(){
  ...
  if(!wStop){
    if((wStart==0)&& (wStop==0)&&digitalRead(SDA_Data)&&digitalRead(SCL_Clock)) {
    ...
    else if ( ( digitalRead(SCL_Clock) == 0 ) && ( writeCounter != 8 ) && !( writeCounter >= 17 ) ) {
      digitalWrite( SDA_Data, address[writeCounter] );
      Serial.println(writeCounter);
      writeCounter++;
    }
    else if ( !(writeCounter > 17) ) {
      if ( !digitalRead(SCL_Clock) ) {
        ...
        if( (!digitalRead(SDA_Data)) ) {
          ...
          Serial .begin("ack wasn't received");
        }
        pinMode(SDA_Data,OUTPUT);
      }
    }
    if ( !digitalRead(SCL_Clock) && (writeCounter==18) ) {
     digitalWrite(SDA_Data, 0);
    }
    else if( digitalRead(SCL_Clock) && (writeCounter==18) ) {
      digitalWrite(SDA_Data, 1);
      // writeCounter=0;
  ...
  if(!rStop){
    ...
    if((wStop==1) && (rStart==0) && (rStop==0)){
     ...
     if((digitalRead(SCL_Clock)==0) && (readCounter<8)) {
       ...
       readData[okunanCounter]=digitalRead(SDA_Data);
       okunanCounter++;
       readCounter++;
       // Serial.println("if 7");
     }
       ...
       number_of_read_channels++;
       readCounter=9;
       pinMode(SDA_Data, INPUT);
       if(number_of_read_channels==4){
         rStop=1;
       }
     }
...
void loop() {
  ...
  if(rStop) {
    ...
    while( i > 3 ) {
      dec_data= dec_data + pow(2,(15-i))*int(readData[i]);
      i = i - 1;
    }
     while( ii > 19 ) {
      dec_data2= dec_data2 + pow(2,(31-ii))*int(readData[ii]);
      ii = ii - 1;
    }
    while( iii > 35 ) {
      dec_data3= dec_data3 + pow(2,(47-iii))*int(readData[iii]);
      iii = iii - 1;
    }
    while( iiii > 51 ){
      dec_data4= dec_data4 + pow(2,(63-iiii))*int(readData[iiii]);
      iiii = iiii - 1;
    }
    if( readData[2] == 0 &&  readData[3] == 0 ) {
      dec_data_kanal=1;
      p1=dec_data;
    }
    else if( readData[2] == 0 &&  readData[3] == 1 ) {
      dec_data_kanal=2;
      p2=dec_data;
    }
    else if( readData[2] == 1 &&  readData[3] == 0 ) {
      dec_data_kanal=3;
      p3=dec_data;
    }
    else if( readData[2] == 1 &&  readData[3] == 1 ) {
      dec_data_kanal=4;
      p4=dec_data;
    }
    ...
    if(readData[18]==0 &&  readData[19]==0) {
      dec_data2_kanal=1;
      p1=dec_data2;
    }
    else if(readData[18]==0 &&  readData[19]==1) {
      dec_data2_kanal=2;
      p2=dec_data2;
    }
    else if(readData[18]==1 &&  readData[19]==0) {
      dec_data2_kanal=3;
      p3=dec_data2;
    }
    else if(readData[18]==1 &&  readData[19]==1){
      dec_data2_kanal=4;
      p4=dec_data2;
    }
    ...
    if(readData[34]==0 &&  readData[35]==0) {
      dec_data3_kanal=1;
      p1=dec_data3;
    }
    else if(readData[34]==0 &&  readData[35]==1) {
      dec_data3_kanal=2;
      p2=dec_data3;
    }
    else if(readData[34]==1 &&  readData[35]==0) {
      dec_data3_kanal=3;
      p3=dec_data3;
    }
    else if(readData[34]==1 &&  readData[35]==1){
      dec_data3_kanal=4;
      p4=dec_data3;
    }
    ...
    if(readData[50]==0 &&  readData[51]==0) {
      dec_data4_kanal=1;
      p1=dec_data4;
    }
    else if(readData[50]==0 &&  readData[51]==1) {
      dec_data4_kanal=2;
      p2=dec_data4;
    }
    else if(readData[50]==1 &&  readData[51]==0) {
      dec_data4_kanal=3;
      p3=dec_data4;
    }
    else if(readData[50]==1 &&  readData[51]==1) {
      dec_data4_kanal=4;
      p4=dec_data4;
    }
    ...
    //determine the letter given the ranges of motion of each finger
